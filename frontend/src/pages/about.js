    ...
    <div>
      ...
      <div className="container">
        <div className="row py-5 my-5">
          ...
          <p>
            Rent a Spot aims to establish a platform that connects parking
        ...
        <div className="row mt-5 mb-5">
          ...
          <div className="col-md-6 d-flex align-items-center">
            <div>
              ...
              <p>
                Parking Seekers can utilize the Rent a Spot web application to
        ...
        <div className="row mt-5">
          <div className="col-md-6 d-flex align-items-center">
            <div className="text-right">
              <h3>Parking Owner</h3>
              <p>
                The Rent a Spot web application offers a professional service
                ...
                Rent a Spot, parking owners can maximize the utilization of
