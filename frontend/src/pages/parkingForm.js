      ...
      <div className="card create-parking-card p-5">
        ...
        <div className="mb-3">
          ...
          <textarea
            ...
            value={form?.address}
            onChange={(e) =>
              handleFormChange({ key: "address", value: e.target.value })
            }
          />
        </div>
        <div className="mb-3">
          ...
          <input
            ...
            value={form?.city}
            onChange={(e) =>
              handleFormChange({ key: "city", value: e.target.value })
            }
          />
        </div>
        <div className="mb-3">
          ...
          <input
            ...
            value={form?.lat}
            onChange={(e) =>
              handleFormChange({ key: "lat", value: e.target.value })
            }
          />
        </div>
        <div className="mb-3">
          ...
          <input
            ...
            value={form?.long}
            onChange={(e) =>
              handleFormChange({ key: "long", value: e.target.value })
            }
          />
        </div>
        <button
