      ...
      <div className="card create-parking-card p-5">
          ...
          <>
            <div className="mb-3 d-flex justify-content-between">
              ...
              <input
                ...
                checked={form?.cash}
                onChange={(e) =>
                  handleFormChange({ key: "cash", value: e.target.checked })
                }
              />
            </div>

            <div className="mb-3">
              <label htmlFor="interac" className="form-label">
                Interac
              </label>
              <input
                type="text"
                ...
                value={form?.interac}
                onChange={(e) =>
                  handleFormChange({ key: "interac", value: e.target.value })
                }
              />
            </div>
          </>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            value={form?.password}
            onChange={(e) =>
              handleFormChange({ key: "password", value: e.target.value })
            }
          />
        </div>
        <div className="mb-3">
